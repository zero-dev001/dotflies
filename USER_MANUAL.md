...
- **Dock**: Left edge, auto-hide with zero delay, 36px icons with magnification, no recent apps, fast Mission Control. Contents reset to Brave, Parallels and a Downloads stack instead of Apple's default dozen
